...
import { IDOCTOR_APPOINTMENTS } from 'src/app/interfaces';

const API = 'doctor/appointments/';

@Injectable({
  providedIn: 'root'
})
export class DoctorAppointmentsService implements IDOCTOR_APPOINTMENTS {
